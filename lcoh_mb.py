...
c2z_loc = os.path.join(root_dir,"LCOH/raw_data/county2zone.csv")
...
h2_transport_stor = pd.read_csv(os.path.join(root_dir,"LCOH/raw_data/h2_transport_and_storage_costs.csv"),
                                names=['type','t','parameter','value'],header=0)
h2_stor = pd.read_csv(os.path.join(root_dir,"LCOH/raw_data/h2_storage_rb.csv"),names=['type','ba'],header=0)
...
h2_stor = pd.read_csv(os.path.join(root_dir,"LCOH/raw_data/h2_storage_rb.csv"),names=['type','r'],header=0)
